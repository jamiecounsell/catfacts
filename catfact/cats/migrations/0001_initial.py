...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Cat'
        db.create_table(u'cats_cat', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], unique=True)),
            ('firstName', self.gf('django.db.models.fields.CharField')(max_length=15, null=True, blank=True)),
            ('lastName', self.gf('django.db.models.fields.CharField')(max_length=15, null=True, blank=True)),
            ...
            ('received', self.gf('cats.models.ListField')()),
        ))
        db.send_create_signal(u'cats', ['Cat'])


    def backwards(self, orm):
        # Deleting model 'Cat'
        db.delete_table(u'cats_cat')
