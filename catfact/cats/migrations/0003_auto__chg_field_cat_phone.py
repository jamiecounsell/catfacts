...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Cat.phone'
        db.alter_column(u'cats_cat', 'phone', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

    def backwards(self, orm):

        # Changing field 'Cat.phone'
        db.alter_column(u'cats_cat', 'phone', self.gf('django.db.models.fields.CharField')(max_length=14, null=True))
